...
@Document(collection = "tminmedias")
public class Tminmedia {
    ...
    @Min(1900)
    @Max(2100)
    private int fecha; // Año al que corresponde el tminmedia
    ...
    public Tminmedia(String id, int fecha, Estacion estacion, Double enero, Double febrero,
