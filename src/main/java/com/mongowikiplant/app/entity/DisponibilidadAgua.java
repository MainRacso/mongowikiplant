...
@Document(collection = "disponibilidadAgua")
public class DisponibilidadAgua {
    ...
    public DisponibilidadAgua() {
        // Constructor por defecto
    }

    public DisponibilidadAgua(String id, int fecha, Estacion estacion, Double enero, Double febrero,
