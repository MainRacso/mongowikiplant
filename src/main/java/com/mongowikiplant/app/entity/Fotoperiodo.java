...
public class Fotoperiodo {
    ...
    public long calcularN() {
        return Stream.of(enero, febrero, marzo, abril, mayo, junio, julio, agosto, septiembre, octubre, noviembre, diciembre)
    ...
    public Double calcularDesviacionEstandar() {
        ...
        return Math.sqrt(Stream.of(enero, febrero, marzo, abril, mayo, junio, julio, agosto, septiembre, octubre, noviembre, diciembre)
                .filter(Objects::nonNull)
                .mapToDouble(Double::doubleValue)
