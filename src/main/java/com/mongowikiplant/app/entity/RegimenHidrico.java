...
@Document(collection = "regimenHidrico")
public class RegimenHidrico {
    ...
    @Min(1900)
    @Max(2100)
    private int fecha; // Año al que corresponde el regimenHidrico
    ...
    public RegimenHidrico() {
        // Constructor por defecto
    }

    public RegimenHidrico(String id, int fecha, Estacion estacion, Double enero, Double febrero,
